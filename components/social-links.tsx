...
export function SocialLinks({ theme = "light", label = "Follow Us" }: SocialLinksProps) {
      ...
      {label && (
        <span
          className={`text-[12px] font-bold uppercase tracking-widest ${
            isDark ? "text-blue-300" : "text-[#64748b]"
          }`}
        >
          {label}
        </span>
          ...
          <Link
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 ${
              isDark
                ...
                : "bg-[#f4f7fb] border border-[#dde4ed] text-[#1b3a5c] hover:bg-[#1b3a5c] hover:text-white hover:border-[#1b3a5c] hover:scale-110"
            }`}
          >
            {s.icon}
          </Link>
